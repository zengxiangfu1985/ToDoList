...
#include <memory>
#include "../../../src/ui/windowtitlebar.h"
...
QT_MOC_LITERAL(1, 15, 17), // "minimizeRequested"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 17), // "maximizeRequested"
QT_MOC_LITERAL(4, 52, 14) // "closeRequested"

    },
    "WindowTitleBar\0minimizeRequested\0\0"
    "maximizeRequested\0closeRequested"
};
...
void WindowTitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WindowTitleBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WindowTitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WindowTitleBar::minimizeRequested)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WindowTitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WindowTitleBar::maximizeRequested)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (WindowTitleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WindowTitleBar::closeRequested)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WindowTitleBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_WindowTitleBar.data,
    qt_meta_data_WindowTitleBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void WindowTitleBar::minimizeRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void WindowTitleBar::maximizeRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void WindowTitleBar::closeRequested()
{
